...
def _serialize_candidate(candidate: TradeCandidate) -> dict:
    ...
    return {
        ...
        'structure': {
            ...
            'dte': dte,
            'entry_credit_points': structure.entry_credit_points if structure else 0,
            'entry_credit_dollars': (structure.entry_credit_points or 0) * 100 if structure else 0,
            'entry_debit_points': structure.entry_debit_points if structure else 0,
            'entry_debit_dollars': (structure.entry_debit_points or 0) * 100 if structure else 0,
            'max_loss_points': structure.max_loss_points if structure else 0,
            'max_loss_dollars': (structure.max_loss_points or 0) * 100 if structure else 0,
            'max_profit_points': structure.max_profit_points if structure else 0,
